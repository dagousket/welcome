...
<span class="ref">{millefeuille}: un package python pour les coordonnées génomique</span>

Ce package en cours de développment permet de manipuler des données génomiques et convertir certains format entre eux (bed6, bed12, gff). Il est écrit en python, et possède une architecture de test unitaire fonctionelle.
